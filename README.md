...
- `problems/oeis-a141057/`: PRD for OEIS A141057 conjecture 2 (Bala's supercongruences for the negative-index extension); the positive half is already solved upstream.
